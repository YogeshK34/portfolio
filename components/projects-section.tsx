    ...
    <section id="projects" className="py-32 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h3 className="text-4xl font-black text-foreground mb-4 bg-gradient-to-r from-secondary to-accent bg-clip-text text-transparent">
            {projects.moreWork}
          </h3>
          <div className="w-24 h-2 bg-secondary mx-auto rounded-full" style={{ boxShadow: "var(--shadow-sm)" }} />
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {otherProjects.map((project, index) => (
            <Card
              key={project.id}
              className="group rounded-[2rem] p-8 border-4 border-foreground bg-card hover:bg-muted/50 hover:-translate-y-2 hover:rotate-1 transition-all duration-500 relative overflow-hidden"
              style={{
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start gap-6">
                  <div
                    className="relative w-24 h-24 rounded-[1.5rem] overflow-hidden flex-shrink-0 group-hover:scale-110 transition-transform duration-300 border-4 border-foreground"
                    style={{ boxShadow: "var(--shadow-md)" }}
                  >
                    <Image
                      src={project.image || "/placeholder.svg"}
                  ...
                  <div className="flex-1">
                    <h4 className="text-2xl font-black text-foreground mb-3 group-hover:text-primary transition-colors duration-300">
                      {project.title}
                    </h4>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tech.slice(0, 4).map((tech, i) => (
                        <span
                          key={tech}
                          className={`px-3 py-1 rounded-xl text-xs font-bold border-2 border-foreground transition-all duration-300 hover:scale-110 ${
                            i % 2 === 0 ? "bg-primary/20 text-primary" : "bg-secondary/20 text-secondary"
                          }`}
                    ...
                    <div className="flex gap-3">
                      <Button
                        size="sm"
                        className="rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-bold transition-all duration-300 hover:scale-105 border-2 border-foreground px-4"
                        style={{ boxShadow: "var(--shadow-sm)" }}
                        asChild
                      >
                        <a href={project.live} target="_blank" rel="noopener noreferrer">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        className="rounded-xl border-2 border-foreground text-foreground hover:bg-foreground hover:text-background font-bold transition-all duration-300 hover:scale-105 px-4 bg-card"
                        style={{ boxShadow: "var(--shadow-sm)" }}
                        asChild
                      >
                        <a href={project.github} target="_blank" rel="noopener noreferrer">
